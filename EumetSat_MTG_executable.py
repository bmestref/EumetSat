...
parser.add_argument('--skip_night_angle', action=float, help="Skip low sun angle scenes (when the sun elevation is below this angle, data retrieval will be skipped)")
